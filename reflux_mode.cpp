...
// РК по жидкости 1 клапан
void rfluxLoopMode_4() {

}
// РК по жидкости 2 клапана (головы, тело)
...
void refluxLoop() {
	...
	switch (processMode.number) {
		...
		case 3: rfluxLoopMode_4(); break; // РК по жидкости 1 клапан
		case 4: rfluxLoopMode_5(); break; // РК по жидкости 2 клапана (головы, тело)
		case 5: rfluxLoopMode_6(); break; // БК регулировка охлаждением
		case 6: rfluxLoopMode_7(); break; // БК регулировка мощностью
	}
}
