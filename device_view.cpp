		...
		switch (processMode.step) {
			...
			case 1: {
				...
				if (touchScreen == 0) {
					...
					if (DS_Res1 != 10 && temperatureSensor[DS_Res1].data < 100.0) tft.printf("T5:%.1f ", temperatureSensor[DS_Res1].data);
					else tft.print("T5:--.-");
					...
					if (DS_Res2 != 10 && temperatureSensor[DS_Res2].data < 100.0) tft.printf("T6:%.1f ", temperatureSensor[DS_Res2].data);
					else tft.print("T6:--.-");
					tft.setCursor(0, 62);
					...
					if (DS_Res3 != 10 && temperatureSensor[DS_Res3].data < 100.0) tft.printf("T7:%.1f ", temperatureSensor[DS_Res3].data);
					else tft.print("T7:--.-");
					...
					if (DS_Res4 != 10 && temperatureSensor[DS_Res4].data < 100.0) tft.printf("T8:%.1f ", temperatureSensor[DS_Res4].data);
					else tft.print("T8:--.-");
